<div>
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex items-center space-x-4">
            <input type="text" icon="magnifying-glass" kbd="⌘K" wire:model.live.debounce.500ms="search" placeholder="Buscar usuario..." class="border rounded-lg px-4 py-2 text-sm w-64 focus:ring focus:ring-gray-300">
                    ...
                    @if ($users->count())
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <th wire:click="sortBy('status')" scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Estatus</th>
                            ...
                            @foreach($users as $user)
                                <tr>
                                    <td class="py-2 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-6">{{$user->name}}</td>
                                    <td class="px-3 py-2 text-sm whitespace-nowrap text-gray-500">{{$user->email}}</td>
